...
function sendMessage(text) {
     ...
     if (text == "quiero comprar una heladera" || text == "Quiero comprar una heladera" ){
         PROXY_URL="json/data1.json";
     };
	 if (text == "Gafa"){
        PROXY_URL="json/data8.json";
     };

     if (text == "Acero inoxidable"){
         PROXY_URL="json/data4.json";
     };

    if (text == "Opción 1"){
        PROXY_URL="json/data18.json";
    };

	 if (text == "como la puedo pagar?"){
    ...
    if (text == "compre una heladera, quiero saber cuando la recibo"){
        PROXY_URL="json/data11.json";
    };
    if (text == "oc01234"){
        PROXY_URL="json/data12.json";
    };
    if (text == "no voy a estar en casa, puede ser mas tarde?"){
        PROXY_URL="json/data13.json";
    };
    if (text == "a las 18hs ya estoy en casa"){
        PROXY_URL="json/data14.json";
    };
    if (text == "muchas gracias"){
        PROXY_URL="json/data7.json";
    };

    if (text == "hola quiero comprar una heladera en cuotas, que alternativas tengo?"){
        PROXY_URL="json/data15.json";
    };

    if (text == "me interesa minicuotas, que requisitos necesito?"){
        PROXY_URL="json/data16.json";
    };

    if (text == "hasta cuanto prestan?"){
        PROXY_URL="json/data17.json";
    };
